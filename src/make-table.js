...
const GARY_QUORA_CSV = 'data/gary-quora.csv';
const GARY_QUORA_HTML = 'dist/GaryTable.html';
// 
// exampleCsvEntry = {
...
const HEADINGS = ['', 'Question', 'Upvotes', 'Comments', 'When' ];
...
const getAnswers = async () => {
    ...
    answers.sort((a, b) => parseInt(a.Upvotes) < parseInt(b.Upvotes) ? 1 : -1);
    return answers
};
...
const main = async () => {
    ...
    answers.forEach((answer, i) => {
        ...
        cells.push(`<a class="question" href="${answer.Link}${ANSWER_SUFFIX}" target=_blank>${i+1}. ${answer.Question}</a><br>
